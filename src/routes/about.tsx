    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "About", item: "https://neneakagi.com/about" },
        ],
      }),
    }],
  }),
