...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "写真家・研究家 朱樹音々 (Nene Akagi) 公式サイト。写真を通して内面を可視化する表現「心象写真」を提唱。展示・ワークショップ・講演・共同研究のご依頼を承ります。" },
      { property: "og:title", content: "NENE AKAGI — 心象写真 Phototherapy Photographer" },
